...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_threes#Bitwise#import() abort
  ...
  execute join(['function! vital#_threes#Bitwise#import() abort', printf("return map({'lshift32': '', 'sign_extension': '', '_vital_created': '', 'rshift': '', 'rshift32': '', 'lshift': '', 'compare': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
" bitwise operators
